...
|:--------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:-----------------------------------------:|
|                  ContentType                 |                                                                                                                                                                                                             Object type to query                                                                                                                                                                                                             |         The runprofile to execute         |
|                SelectProperty                |                                                                                                                                                  The property to select from the result. If this setting is left empty, the entire result object or collection will be placed in an argument                                                                                                                                                 |          The connector to execute         |
|                 SortProperty                 |                                                                                                                                                                                                    The property to sort the result set on                                                                                                                                                                                                    | The operation to execute on the connector |
